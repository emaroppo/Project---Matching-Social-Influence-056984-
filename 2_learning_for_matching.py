...
# initialize bandit
ucb_bandit = UCBMatching(n_node_classes*n_product_classes, n_node_classes, n_product_classes, n_products_per_class)
ts_bandit = TSMatching2(n_node_classes*n_product_classes, n_node_classes, n_product_classes, n_products_per_class)

n_experiments = 365

matching_metrics = matching_simulation(env, ucb_bandit, n_experiments, class_mapping=class_mapping)
